 ...
 * with a leading and trailing blank row padding the band (ADR-0005).
 */
function renderHeader(theme: Theme, width: number, cwd: string, sections: ResourceSection[]): string[] {
	...
	// Blank rows above and below the band breathe space between it and the
	// screen edge / the prompt below.
	return ["", ...band, ""];
}
